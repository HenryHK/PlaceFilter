...
import analysisTask1.PlaceFilterMapper;
...
public class PlaceFilterMapperTest 
{
	...
	public void processValidRecord() throws IOException
	{
		...
		Text input = new Text("xPOpvDeYBJkdlw	15596	51.504	-0.609	Chalvey, Slough, England, GB, United Kingdom	22	/United+Kingdom/England/Slough/Chalvey");
