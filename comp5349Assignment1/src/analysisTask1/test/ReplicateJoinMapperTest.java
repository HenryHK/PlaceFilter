...
import analysisTask1.ReplicateJoinMapper;
...
public class ReplicateJoinMapperTest 
{
	...
	public void processValidRecord() throws IOException
	{
		...
		try
		{
			...
			verify(context).write(new Text("Batur Utara, Bali, Indonesia"), new Text("november bw white black leaves rain foglie may bn pioggia bianco nero"));
		}
		catch (Exception e)
		{
			e.printStackTrace();
